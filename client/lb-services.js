  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Contact.enrollments.findById() instead.
        "prototype$__findById__enrollments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/contacts/:id/enrollments/:fk",
          method: "GET"
        },

        // INTERNAL. Use Contact.enrollments.destroyById() instead.
        "prototype$__destroyById__enrollments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/contacts/:id/enrollments/:fk",
        ...
        // INTERNAL. Use Contact.enrollments.updateById() instead.
        "prototype$__updateById__enrollments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/contacts/:id/enrollments/:fk",
        ...
        // INTERNAL. Use Contact.enrollments() instead.
        "prototype$__get__enrollments": {
          isArray: true,
          url: urlBase + "/contacts/:id/enrollments",
          method: "GET"
        },

        // INTERNAL. Use Contact.enrollments.create() instead.
        "prototype$__create__enrollments": {
          url: urlBase + "/contacts/:id/enrollments",
          method: "POST"
        },

        // INTERNAL. Use Contact.enrollments.destroyAll() instead.
        "prototype$__delete__enrollments": {
          url: urlBase + "/contacts/:id/enrollments",
          method: "DELETE"
        },

        // INTERNAL. Use Contact.enrollments.count() instead.
        "prototype$__count__enrollments": {
        ...
        // INTERNAL. Use Center.contacts.destroyById() instead.
        "::destroyById::center::contacts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/centers/:id/contacts/:fk",
        ...
        // INTERNAL. Use Center.contacts.updateById() instead.
        "::updateById::center::contacts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/centers/:id/contacts/:fk",
        ...
        // INTERNAL. Use Center.contacts() instead.
        "::get::center::contacts": {
          isArray: true,
          url: urlBase + "/centers/:id/contacts",
          method: "GET"
        },

        // INTERNAL. Use Center.contacts.create() instead.
        "::create::center::contacts": {
          url: urlBase + "/centers/:id/contacts",
          method: "POST"
        },

        // INTERNAL. Use Center.contacts.createMany() instead.
        "::createMany::center::contacts": {
          isArray: true,
          url: urlBase + "/centers/:id/contacts",
          method: "POST"
        },

        // INTERNAL. Use Center.contacts.destroyAll() instead.
        "::delete::center::contacts": {
          url: urlBase + "/centers/:id/contacts",
          method: "DELETE"
        },

        // INTERNAL. Use Center.contacts.count() instead.
        "::count::center::contacts": {
          url: urlBase + "/centers/:id/contacts/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Contact.enrollments
     * @header lbServices.Contact.enrollments
     * @object
     * @description
     *
     * The object `Contact.enrollments` groups methods
     * manipulating `Enrollment` instances related to `Contact`.
     *
     * Call {@link lbServices.Contact#enrollments Contact.enrollments()}
     ...
     */
         ...
         * @description
         *
         * Queries enrollments of contact.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.enrollments = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::get::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#count
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         * Counts enrollments of contact.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.enrollments.count = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::count::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#create
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         ...
         * </em>
         */
        R.enrollments.create = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::create::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#createMany
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         ...
         * </em>
         */
        R.enrollments.createMany = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::createMany::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#destroyAll
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.enrollments.destroyAll = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::delete::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#destroyById
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         ...
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for enrollments
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.enrollments.destroyById = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::destroyById::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#findById
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         ...
         * </em>
         */
        R.enrollments.findById = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::findById::contact::enrollments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.enrollments#updateById
         * @methodOf lbServices.Contact.enrollments
         *
         * @description
         *
         ...
         * </em>
         */
        R.enrollments.updateById = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::updateById::contact::enrollments"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Contact.reminders#createMany
         * @methodOf lbServices.Contact.reminders
         *
         * @description
         *
         ...
         * </em>
         */
        R.reminders.createMany = function() {
          var TargetResource = $injector.get("Reminder");
          var action = TargetResource["::createMany::contact::reminders"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Program.enrollment#createMany
         * @methodOf lbServices.Program.enrollment
         *
         * @description
         *
         ...
         * </em>
         */
        R.enrollment.createMany = function() {
          var TargetResource = $injector.get("Enrollment");
          var action = TargetResource["::createMany::program::enrollment"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Center.expenses.findById() instead.
        "prototype$__findById__expenses": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/centers/:id/expenses/:fk",
          method: "GET"
        },

        // INTERNAL. Use Center.expenses.destroyById() instead.
        ...
        // INTERNAL. Use Center.expenses.updateById() instead.
        ...
        // INTERNAL. Use Center.expenses() instead.
        "prototype$__get__expenses": {
          isArray: true,
          url: urlBase + "/centers/:id/expenses",
          method: "GET"
        },

        // INTERNAL. Use Center.expenses.create() instead.
        "prototype$__create__expenses": {
          url: urlBase + "/centers/:id/expenses",
          method: "POST"
        },

        // INTERNAL. Use Center.expenses.destroyAll() instead.
        "prototype$__delete__expenses": {
          url: urlBase + "/centers/:id/expenses",
          method: "DELETE"
        },

        // INTERNAL. Use Center.expenses.count() instead.
        "prototype$__count__expenses": {
          url: urlBase + "/centers/:id/expenses/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Expense.center() instead.
        "::get::expense::center": {
          url: urlBase + "/expenses/:id/center",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Center.contacts
     * @header lbServices.Center.contacts
     * @object
     * @description
     *
     * The object `Center.contacts` groups methods
     * manipulating `Contact` instances related to `Center`.
     *
     * Call {@link lbServices.Center#contacts Center.contacts()}
     * to query all related instances.
     */
        ...
        R.contacts = function() {
          ...
          var action = TargetResource["::get::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#count
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
         * Counts contacts of center.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.contacts.count = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::count::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#create
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
        ...
        R.contacts.create = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::create::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#createMany
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
        ...
        R.contacts.createMany = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::createMany::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#destroyAll
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
        ...
        R.contacts.destroyAll = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::delete::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#destroyById
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
        ...
        R.contacts.destroyById = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::destroyById::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#findById
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
        ...
        R.contacts.findById = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::findById::center::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.contacts#updateById
         * @methodOf lbServices.Center.contacts
         *
         * @description
         *
        ...
        R.contacts.updateById = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::updateById::center::contacts"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Center.expenses
     * @header lbServices.Center.expenses
     * @object
     * @description
     *
     * The object `Center.expenses` groups methods
     * manipulating `Expense` instances related to `Center`.
     *
     * Call {@link lbServices.Center#expenses Center.expenses()}
     * to query all related instances.
     */
        ...
        R.expenses = function() {
          ...
          var action = TargetResource["::get::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#count
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
         * Counts expenses of center.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.expenses.count = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::count::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#create
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
        ...
        R.expenses.create = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::create::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#createMany
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
        ...
        R.expenses.createMany = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::createMany::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#destroyAll
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
        ...
        R.expenses.destroyAll = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::delete::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#destroyById
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
        ...
        R.expenses.destroyById = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::destroyById::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#findById
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
        ...
        R.expenses.findById = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::findById::center::expenses"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Center.expenses#updateById
         * @methodOf lbServices.Center.expenses
         *
         * @description
         *
        ...
        R.expenses.updateById = function() {
          var TargetResource = $injector.get("Expense");
          var action = TargetResource["::updateById::center::expenses"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Center.expenses.create() instead.
        "::create::center::expenses": {
          url: urlBase + "/centers/:id/expenses",
          method: "POST"
        },

        // INTERNAL. Use Center.expenses.createMany() instead.
        "::createMany::center::expenses": {
          isArray: true,
          url: urlBase + "/centers/:id/expenses",
          method: "POST"
        },
        ...
        // INTERNAL. Use Center.expenses.destroyAll() instead.
        "::delete::center::expenses": {
          url: urlBase + "/centers/:id/expenses",
          method: "DELETE"
        },

        // INTERNAL. Use Center.expenses.count() instead.
        "::count::center::expenses": {
          url: urlBase + "/centers/:id/expenses/count",
          method: "GET"
        },
      }
    ...
    */
    R.modelName = "Expense";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Expense#center
         * @methodOf lbServices.Expense
         *
         * @description
         *
        ...
        R.center = function() {
          ...
          var action = TargetResource["::get::expense::center"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Income
 * @header lbServices.Income
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Income` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Income#create
         * @methodOf lbServices.Income
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Income` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/incomes",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Income#createMany
         * @methodOf lbServices.Income
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/incomes/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Income#findById
         * @methodOf lbServices.Income
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/incomes/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Income#find
         * @methodOf lbServices.Income
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Income#findOne
         * @methodOf lbServices.Income
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/incomes/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Income#updateAll
         * @methodOf lbServices.Income
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/incomes/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Income#deleteById
         * @methodOf lbServices.Income
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/incomes/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Income#prototype$updateAttributes
         * @methodOf lbServices.Income
         *
         * @description
         *
        ...
        // INTERNAL. Use Enrollment.incomes.findById() instead.
        "::findById::enrollment::incomes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/enrollments/:id/incomes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Enrollment.incomes.destroyById() instead.
        "::destroyById::enrollment::incomes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/enrollments/:id/incomes/:fk",
        ...
        // INTERNAL. Use Enrollment.incomes.updateById() instead.
        "::updateById::enrollment::incomes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/enrollments/:id/incomes/:fk",
        ...
        // INTERNAL. Use Enrollment.incomes() instead.
        "::get::enrollment::incomes": {
          isArray: true,
          url: urlBase + "/enrollments/:id/incomes",
          method: "GET"
        },

        // INTERNAL. Use Enrollment.incomes.create() instead.
        "::create::enrollment::incomes": {
          url: urlBase + "/enrollments/:id/incomes",
          method: "POST"
        },

        // INTERNAL. Use Enrollment.incomes.createMany() instead.
        "::createMany::enrollment::incomes": {
          isArray: true,
          url: urlBase + "/enrollments/:id/incomes",
          method: "POST"
        },

        // INTERNAL. Use Enrollment.incomes.destroyAll() instead.
        "::delete::enrollment::incomes": {
          url: urlBase + "/enrollments/:id/incomes",
          method: "DELETE"
        },

        // INTERNAL. Use Enrollment.incomes.count() instead.
        "::count::enrollment::incomes": {
          url: urlBase + "/enrollments/:id/incomes/count",
          method: "GET"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Income#updateOrCreate
         * @methodOf lbServices.Income
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Income#destroyById
         * @methodOf lbServices.Income
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Income#removeById
         * @methodOf lbServices.Income
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Income#modelName
    * @propertyOf lbServices.Income
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Income`.
    */
    R.modelName = "Income";
        ...
        R.center = function() {
          var TargetResource = $injector.get("Center");
          var action = TargetResource["::get::income::center"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Enrollment
 * @header lbServices.Enrollment
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Enrollment` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/enrollments/:id",
      { 'id': '@id' },
      {

        // INTERNAL. Use Enrollment.incomes.findById() instead.
        "prototype$__findById__incomes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/enrollments/:id/incomes/:fk",
        ...
        // INTERNAL. Use Enrollment.incomes.destroyById() instead.
        "prototype$__destroyById__incomes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/enrollments/:id/incomes/:fk",
        ...
        // INTERNAL. Use Enrollment.incomes.updateById() instead.
        "prototype$__updateById__incomes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/enrollments/:id/incomes/:fk",
        ...
        // INTERNAL. Use Enrollment.incomes.create() instead.
        "prototype$__create__incomes": {
          url: urlBase + "/enrollments/:id/incomes",
          method: "POST"
        },

        // INTERNAL. Use Enrollment.incomes.destroyAll() instead.
        "prototype$__delete__incomes": {
          url: urlBase + "/enrollments/:id/incomes",
          method: "DELETE"
        },

        // INTERNAL. Use Enrollment.incomes.count() instead.
        "prototype$__count__incomes": {
          url: urlBase + "/enrollments/:id/incomes/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#create
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#createMany
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#upsert
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#exists
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/enrollments/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Enrollment#findById
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/enrollments/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Enrollment#find
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#findOne
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/enrollments/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Enrollment#updateAll
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/enrollments/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Enrollment#deleteById
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#count
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/enrollments/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Enrollment#prototype$updateAttributes
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#newEnrollment
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
         ...
         */
        "newEnrollment": {
          url: urlBase + "/enrollments/newEnrollment",
          method: "POST"
        },

        // INTERNAL. Use Contact.enrollments.findById() instead.
        "::findById::contact::enrollments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/contacts/:id/enrollments/:fk",
        ...
        // INTERNAL. Use Contact.enrollments.destroyById() instead.
        "::destroyById::contact::enrollments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/contacts/:id/enrollments/:fk",
        ...
        // INTERNAL. Use Contact.enrollments.updateById() instead.
        "::updateById::contact::enrollments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/contacts/:id/enrollments/:fk",
        ...
        // INTERNAL. Use Contact.enrollments.create() instead.
        "::create::contact::enrollments": {
          url: urlBase + "/contacts/:id/enrollments",
          method: "POST"
        },

        // INTERNAL. Use Contact.enrollments.createMany() instead.
        "::createMany::contact::enrollments": {
          isArray: true,
          url: urlBase + "/contacts/:id/enrollments",
          method: "POST"
        },
        ...
        // INTERNAL. Use Program.enrollment.createMany() instead.
        "::createMany::program::enrollment": {
          isArray: true,
          url: urlBase + "/programs/:id/enrollment",
          method: "POST"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#updateOrCreate
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#update
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#destroyById
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#removeById
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Enrollment#modelName
    * @propertyOf lbServices.Enrollment
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Enrollment`.
    */
    R.modelName = "Enrollment";

    /**
     * @ngdoc object
     * @name lbServices.Enrollment.incomes
     * @header lbServices.Enrollment.incomes
     * @object
     * @description
     *
     * The object `Enrollment.incomes` groups methods
     * manipulating `Income` instances related to `Enrollment`.
     *
     * Call {@link lbServices.Enrollment#incomes Enrollment.incomes()}
     * to query all related instances.
     */
        ...
        R.incomes = function() {
          ...
          var action = TargetResource["::get::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#count
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
         * Counts incomes of enrollment.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.incomes.count = function() {
          var TargetResource = $injector.get("Income");
          var action = TargetResource["::count::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#create
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
         ...
         * </em>
         */
        R.incomes.create = function() {
          var TargetResource = $injector.get("Income");
          var action = TargetResource["::create::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#createMany
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
         ...
         * </em>
         */
        R.incomes.createMany = function() {
          var TargetResource = $injector.get("Income");
          var action = TargetResource["::createMany::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#destroyAll
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.incomes.destroyAll = function() {
          var TargetResource = $injector.get("Income");
          var action = TargetResource["::delete::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#destroyById
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        R.incomes.destroyById = function() {
          var TargetResource = $injector.get("Income");
          var action = TargetResource["::destroyById::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#findById
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
         ...
         * </em>
         */
        R.incomes.findById = function() {
          var TargetResource = $injector.get("Income");
          var action = TargetResource["::findById::enrollment::incomes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Enrollment.incomes#updateById
         * @methodOf lbServices.Enrollment.incomes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Enrollment#contact
         * @methodOf lbServices.Enrollment
         *
         * @description
         *
        ...
        R.contact = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::get::enrollment::contact"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Reminder#prototype$updateAttributes
         * @methodOf lbServices.Reminder
         *
         * @description
         *
        ...
        // INTERNAL. Use Contact.reminders.createMany() instead.
        "::createMany::contact::reminders": {
          isArray: true,
          url: urlBase + "/contacts/:id/reminders",
          method: "POST"
        },
